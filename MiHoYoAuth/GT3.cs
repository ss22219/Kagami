    ...
    public static class GT3
    {
        public static async Task<CaptchaData> GetGeetest()
        {
            ...
            app.MapGet("/config", async context =>
            {
                ...
                var mmt = await MiHoYoAPI.CreateMMT();
                mmtKey = mmt["mmt_key"].ToString();
                await context.Response.WriteAsync(mmt.ToString(formatting: Formatting.Indented));
            });
            ...
            return new CaptchaData(mmtKey, geetest.geetest_seccode, geetest.geetest_validate,
...
<head>
    <meta charset=""UTF-8"">
    <title>Title</title>
    <script src=""gt.js"" type=""application/javascript""></script>
</head>
<body>
<div id=""gt""></div>
<script>
